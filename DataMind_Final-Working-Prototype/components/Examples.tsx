...
const EXAMPLES = [
  ...
  },
  {
    ...
    body: "Geographic aggregation from workforce addresses.",
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {EXAMPLES.map((ex) => (
            <button
              ...
              className="hover-lift group flex flex-col items-start rounded-sm border border-ink-800 bg-ink-950 p-7 text-left transition-colors duration-200 hover:border-accent-500/60 hover:shadow-[0_12px_28px_-8px_rgb(var(--accent-500)/0.25)]"
            >
